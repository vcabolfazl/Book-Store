  ...
  <>
   <div className='mb-28 md:mb-56 transition-all'>
    ...
    <div className={`${showMenu ? "block z-50 inset-0 overlay fixed h-full p-3 w-2/3 sm:w-1/2 overflow-y-auto right-0 top-0 bg-white" : "hidden"}`}>
     ...
     <form action="" className='w-full my-5 bg-gray-400 flex items-center justify-between px-3 py-2 rounded-xl text-sm'>
      <input type="search" className='bg-inherit outline-none w-full text-zinc-700 placeholder:text-zinc-700 font-dana-Bold' placeholder='دنبال چی میگردی ؟' name="" id="" />
      <svg className="w-8 h-8 text-gray-200">
       <use href='#Search'></use>
      </svg>
     </form>
     ...
     <div className={`m-0 md:m-auto ${menuScroll ? "container" : ""}`}>
      ...
      <div className={`grid grid-cols-3 md:grid-cols-4 items-center
       ...
       <div className="hidden md:block col-span-2">
        <form action="" className='w-full bg-gray-400 flex items-center justify-between px-4 py-3 rounded-xl'>
         <input type="search" className='bg-inherit outline-none w-full text-zinc-700 placeholder:text-zinc-700 font-dana-Bold' placeholder='دنبال چی میگردی ؟' name="" id="" />
         <svg className="w-8 h-8 text-gray-200">
          <use href='#Search'></use>
         </svg>
